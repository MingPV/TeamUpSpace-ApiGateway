...
const file_proto_question_question_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/question/question.proto\x12\bquestion\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"\xc5\x01\n" +
	"\bQuestion\x12\x0e\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\xfa\x05\n" +
	...
	"\x10FindQuestionByID\x12!.question.FindQuestionByIDRequest\x1a\".question.FindQuestionByIDResponse\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/questions/{id}\x12v\n" +
	"\x10FindAllQuestions\x12!.question.FindAllQuestionsRequest\x1a\".question.FindAllQuestionsResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/v1/userReports\x12\x96\x01\n" +
