...
func (c *notificationServiceClient) FindNotificationByID(ctx context.Context, in *FindNotificationByIDRequest, opts ...grpc.CallOption) (*FindNotificationByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notification.NotificationService/FindNotificationByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) FindAllNotifications(ctx context.Context, in *FindAllNotificationsRequest, opts ...grpc.CallOption) (*FindAllNotificationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notification.NotificationService/FindAllNotifications", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) PatchNotification(ctx context.Context, in *PatchNotificationRequest, opts ...grpc.CallOption) (*PatchNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notification.NotificationService/PatchNotification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_FindNotificationByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notification.NotificationService/FindNotificationByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_FindAllNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notification.NotificationService/FindAllNotifications",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NotificationService_PatchNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notification.NotificationService/PatchNotification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
