...
const file_proto_userfollow_userfollow_proto_rawDesc = "" +
	...
	"userfollow\x1a\x1cgoogle/api/annotations.proto\"a\n" +
	"\n" +
	"UserFollow\x12\x17\n" +
	...
	"\fuser_follows\x18\x01 \x03(\v2\x16.userfollow.UserFollowR\vuserFollows2\xaf\x04\n" +
	"\x11UserFollowService\x12k\n" +
	"\n" +
	"FollowUser\x12\x1d.userfollow.FollowUserRequest\x1a\x1e.userfollow.FollowUserResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/v1/userFollows\x12\x84\x01\n" +
	"\fUnfollowUser\x12\x1f.userfollow.UnfollowUserRequest\x1a .userfollow.UnfollowUserResponse\"1\x82\xd3\xe4\x93\x02+*)/api/v1/userFollows/{user_id}/{follow_to}\x12\x90\x01\n" +
	"\x10FindAllFollowers\x12#.userfollow.FindAllFollowersRequest\x1a$.userfollow.FindAllFollowersResponse\"1\x82\xd3\xe4\x93\x02+\x12)/api/v1/userFollows/followers/{follow_to}\x12\x92\x01\n" +
	"\x11FindAllFollowings\x12$.userfollow.FindAllFollowingsRequest\x1a%.userfollow.FindAllFollowingsResponse\"0\x82\xd3\xe4\x93\x02*\x12(/api/v1/userFollows/followings/{user_id}B\x12Z\x10proto/userfollowb\x06proto3"
