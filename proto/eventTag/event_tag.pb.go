...
const file_proto_eventTag_event_tag_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/eventTag/event_tag.proto\x12\tevent_tag\x1a\x1cgoogle/api/annotations.proto\"z\n" +
	"\bEventTag\x12\x19\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage2\x91\x06\n" +
	"\x0fEventTagService\x12s\n" +
	"\x0eCreateEventTag\x12 .event_tag.CreateEventTagRequest\x1a!.event_tag.CreateEventTagResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/api/v1/eventTags\x12\x93\x01\n" +
	"\x13FindByEventAndTagID\x12%.event_tag.FindByEventAndTagIDRequest\x1a&.event_tag.FindByEventAndTagIDResponse\"-\x82\xd3\xe4\x93\x02'\x12%/api/v1/eventTags/{event_id}/{tag_id}\x12~\n" +
	"\rFindByEventID\x12\x1f.event_tag.FindByEventIDRequest\x1a .event_tag.FindByEventIDResponse\"*\x82\xd3\xe4\x93\x02$\x12\"/api/v1/eventTags/event/{event_id}\x12t\n" +
	"\vFindByTagID\x12\x1d.event_tag.FindByTagIDRequest\x1a\x1e.event_tag.FindByTagIDResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/api/v1/eventTags/tag/{tag_id}\x12v\n" +
	"\x10FindAllEventTags\x12\".event_tag.FindAllEventTagsRequest\x1a#.event_tag.FindAllEventTagsResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/api/v1/eventTags\x12\x84\x01\n" +
	"\x0eDeleteEventTag\x12 .event_tag.DeleteEventTagRequest\x1a!.event_tag.DeleteEventTagResponse\"-\x82\xd3\xe4\x93\x02'*%/api/v1/eventTags/{event_id}/{tag_id}B\x10Z\x0eproto/eventTagb\x06proto3"

var (
	file_proto_eventTag_event_tag_proto_rawDescOnce sync.Once
	file_proto_eventTag_event_tag_proto_rawDescData []byte
)

func file_proto_eventTag_event_tag_proto_rawDescGZIP() []byte {
	file_proto_eventTag_event_tag_proto_rawDescOnce.Do(func() {
		file_proto_eventTag_event_tag_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_eventTag_event_tag_proto_rawDesc), len(file_proto_eventTag_event_tag_proto_rawDesc)))
	})
...
var file_proto_eventTag_event_tag_proto_goTypes = []any{
...
func file_proto_eventTag_event_tag_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_eventTag_event_tag_proto_rawDesc), len(file_proto_eventTag_event_tag_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
